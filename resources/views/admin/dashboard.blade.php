                ...
                <div class="col-lg-4">
                    ...
                    <a href="#" class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="font-weight-bold text-inverse-white font-size-sm">{{ App\Models\Service::count() }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Stats Widget 16-->
                ...
                <div class="col-lg-4">
                    ...
                    <a href="#" class="card card-custom bg-info bg-hover-state-info card-stretch card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="font-weight-bold text-inverse-info font-size-sm">{{ App\Models\User::count() }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Stats Widget 17-->
                ...
                <div class="col-lg-4">
                    ...
                    <a href="#" class="card card-custom bg-dark bg-hover-state-dark card-stretch gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="font-weight-bold text-inverse-dark font-size-sm">{{ App\Models\Appointment::count() }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Stats Widget 18-->
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body py-0">
                    ...
                    <div class="table-responsive">
                       <table class="table  table-condensed table-hover text-nowrap table-bordered" id="users_datatable">
                            <thead>
                                <tr>
                                    <th width="3%">#</th>
