            ...
            <div class="card card-custom card-stretch">
                ...
                <div class="card-header py-3">
                    <div class="card-title align-items-start flex-column">
                        <h3 class="card-label font-weight-bolder text-dark"> المعلومات الشخصية | {{ $userProfile->name }}</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <img id="image_porfile" src="{{asset('images/users/'. $userProfile->image) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <input class="form-control form-control-lg form-control-solid" id="name"
                                    placeholder="الإسم" type="text" name="name" value="{{ $userProfile->name }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="input-group input-group-lg input-group-solid">
                                    ...
                                    <input type="text" name="email" id="email"
                                        ...
                                        value="{{ $userProfile->email }}" placeholder="البريد">
                                </div>
                        ...
                        <div class="row">
                            <label class="col-xl-3"></label>
                            <div class="col-lg-9 col-xl-6">
                                <h5 class="font-weight-bold mt-10 mb-6">معلومات التواصل</h5>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="input-group input-group-lg input-group-solid">
                                    ...
                                    <input type="text" name="phone"
                                        class="form-control form-control-lg form-control-solid"
                                        value="{{ $userProfile->phone }}" placeholder="رقم الهاتف">
                                </div>
                            </div>
                        </div>
    ...
    $(function () {
        ...
        var SITEURL = '{{URL::to('')}}';
            $(document).on('click','#EditsaveBtn',function() {
               ...
               $.ajax({
                url:"/dashboard/users/update-profile",
                method:'post',
                data:form_data,
                dataType:'json',
               ...
               $('#image_porfile').attr('src',"/images/users/"+response.data.image)
               $("#file-image").val("")
